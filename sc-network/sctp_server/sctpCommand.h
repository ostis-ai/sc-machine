...
protected:
  ...
  typedef eSctpErrorCode (
      *fProcessCommand)(quint8 cmdFlags, quint32 cmdId, QDataStream * params, QIODevice * outDevice);
...
private:
  ...
  eSctpErrorCode processIterateConstruction(
      quint32 cmdFlags,
      quint32 cmdId,
      QDataStream * params,
      QIODevice * outDevice);
  eSctpErrorCode processGenerateConstruction(
      quint32 cmdFlags,
      quint32 cmdId,
      QDataStream * params,
      QIODevice * outDevice);
  ...
  eSctpErrorCode processFindElementBySysIdtf(
      quint32 cmdFlags,
      quint32 cmdId,
      QDataStream * params,
      QIODevice * outDevice);
