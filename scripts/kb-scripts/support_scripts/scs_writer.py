...
NodeTypeSets = {
    ...
    "node/const/terminal": ["sc_node_superclass"],
    ...
    "node/const/perm/terminal": ["sc_node_superclass"],
    ...
    "node/const/temp/terminal": ["sc_node_superclass"],
    ...
    "node/var/terminal": ["sc_node_superclass"],
    ...
    "node/var/perm/terminal": ["sc_node_superclass"],
    ...
    "node/var/temp/terminal": ["sc_node_superclass"],
