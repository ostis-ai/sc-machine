...
The **C++ Actions API** is dedicated to defining and executing actions that agents can perform within the sc-machine environment. This section provides guidelines on how to implement various actions, including their parameters and expected outcomes.
