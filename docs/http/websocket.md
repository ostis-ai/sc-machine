  ...
  "payload": [
    ...
    [
      ...
      },
      {
        ...
        "alias": "trg"  // can be used in next triples to ref this element
      }
    ],
    [
      {
      ...
      {
        "type": "alias",
        "value": "edge1"  // ref to first triple element
      }
    ],
    ...
  ]
...
```json
{
  ...
  "payload": {
    ...
    "addrs": [
      [23, 412, 423], // addrs for 1st result
      [33, 543, 345], // addrs for 2nd result
      [542, 897, 129],
      ...
    ]
  }
...
```json
{
  ..., // common response data
  "payload": {
    /* This map contains ScAddr's of generated elements
     * for each alias from template.
     */
    "trg": 564,
    "edge1": 121,
    "edge2": 323
