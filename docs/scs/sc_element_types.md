...
| ScType::CommonArc               | Not specified                                                          | ```?=> <=?```        |
| ScType::MembershipArc           | Not specified                                                          | ```???> <???```      |
...
| ScType::ConstCommonArc          | <img src="../images/scg/scg_const_common_arc.png"></img>               | ```=> <=```          |
| ScType::VarCommonArc            | <img src="../images/scg/scg_var_common_arc.png"></img>                 | ```_=> <=_```        |
| ScType::ConstMembershipArc      | Not specified                                                          | ```??> <??```        |
| ScType::VarMembershipArc        | Not specified                                                          | ```_??> <??_```      |
| ScType::PermArc                 | Not specified                                                          | ```?-?> <?-?```      |
| ScType::TempArc                 | Not specified                                                          | ```?..?> <?..?```    |
| ScType::ConstPermArc            | Not specified                                                          | ```-?> <?-```        |
| ScType::VarPermArc              | Not specified                                                          | ```_-?> <?-_```      |
| ScType::ConstTempArc            | Not specified                                                          | ```..?> <?..```      |
| ScType::VarTempArc              | Not specified                                                          | ```_..?> <?.._```    |
| ScType::ActualTempArc           | Not specified                                                          | ```?~?> <?~?```      |
| ScType::InactualTempArc         | Not specified                                                          | ```?%?> <?%?```      |
| ScType::ConstActualTempArc      | Not specified                                                          | ```~?> <?~```        |
| ScType::VarActualTempArc        | Not specified                                                          | ```_~?> <?~_```      |
| ScType::ConstInactualTempArc    | Not specified                                                          | ```%?> <?%```        |
| ScType::VarInactualTempArc      | Not specified                                                          | ```_%?> <?%_```      |
| ScType::PosArc                  | Not specified                                                          | ```??> <??```        |
| ScType::NegArc                  | Not specified                                                          | ```??|> <|??```      |
| ScType::FuzArc                  | Not specified                                                          | ```?/> </?```        |
| ScType::ConstPosArc             | Not specified                                                          | ```?> <?```          |
| ScType::VarPosArc               | Not specified                                                          | ```_?> <?_```        |
| ScType::PermPosArc              | Not specified                                                          | ```?-> <-?```        |
| ScType::TempPosArc              | Not specified                                                          | ```?..> <..?```      |
| ScType::ActualTempPosArc        | Not specified                                                          | ```?~> <~?```        |
| ScType::InactualTempPosArc      | Not specified                                                          | ```?%> <%?```        |
| ScType::ConstPermPosArc         | <img src="../images/scg/scg_const_perm_pos_arc.png"></img>             | ```-> <-```          |
| ScType::ConstTempPosArc         | <img src="../images/scg/scg_const_temp_pos_arc.png"></img>             | ```..> <..```        |
| ScType::ConstActualTempPosArc   | <img src="../images/scg/scg_const_actual_temp_pos_arc.png"></img>      | ```~> <~```          |
| ScType::ConstInactualTempPosArc | <img src="../images/scg/scg_const_inactual_temp_pos_arc.png"></img>    | ```%> <%```          |
| ScType::VarPermPosArc           | <img src="../images/scg/scg_var_perm_pos_arc.png"></img>               | ```_-> <-_```        |
| ScType::VarTempPosArc           | <img src="../images/scg/scg_var_temp_pos_arc.png"></img>               | ```_..> <.._```      |
| ScType::VarActualTempPosArc     | <img src="../images/scg/scg_var_actual_temp_pos_arc.png"></img>        | ```_~> <~_```        |
| ScType::VarInactualTempPosArc   | <img src="../images/scg/scg_var_inactual_temp_pos_arc.png"></img>      | ```_%> <%_```        |
| ScType::ConstNegArc             | Not specified                                                          | ```?|> <|?```        |
| ScType::VarNegArc               | Not specified                                                          | ```_?|> <|?_```      |
| ScType::PermNegArc              | Not specified                                                          | ```?-|> <|-?```      |
| ScType::TempNegArc              | Not specified                                                          | ```?..|> <|..?```    |
| ScType::ActualTempNegArc        | Not specified                                                          | ```?~|> <|~?```      |
| ScType::InactualTempNegArc      | Not specified                                                          | ```?%|> <|%?```      |
| ScType::ConstPermNegArc         | <img src="../images/scg/scg_const_perm_neg_arc.png"></img>             | ```-|> <|-```        |
| ScType::ConstTempNegArc         | <img src="../images/scg/scg_const_temp_neg_arc.png"></img>             | ```..|> <|..```      |
| ScType::ConstActualTempNegArc   | <img src="../images/scg/scg_const_actual_temp_neg_arc.png"></img>      | ```~|> <|~```        |
| ScType::ConstInactualTempNegArc | <img src="../images/scg/scg_const_inactual_temp_neg_arc.png"></img>    | ```%|> <|%```        |
| ScType::VarPermNegArc           | <img src="../images/scg/scg_var_perm_neg_arc.png"></img>               | ```_-|> <|-_```      |
| ScType::VarTempNegArc           | <img src="../images/scg/scg_var_temp_neg_arc.png"></img>               | ```_..|> <|.._```    |
| ScType::VarActualTempNegArc     | <img src="../images/scg/scg_var_actual_temp_neg_arc.png"></img>        | ```_~|> <|~_```      |
| ScType::VarInactualTempNegArc   | <img src="../images/scg/scg_var_inactual_temp_neg_arc.png"></img>      | ```_%|> <|%_```      |
| ScType::ConstFuzArc             | <img src="../images/scg/scg_const_fuz_arc.png"></img>                  | ```/> </```          |
| ScType::VarFuzArc               | <img src="../images/scg/scg_var_fuz_arc.png"></img>                    | ```_/> </_```        |
