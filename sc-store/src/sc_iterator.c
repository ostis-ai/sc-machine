...
gboolean _sc_iterator3_f_a_a_next(sc_iterator3 *it)
{
  sc_addr arc_addr;
  sc_element *el1, *el2;
  ...
  {
    el1 = sc_storage_get_element(it->params[0].addr, TRUE);
    arc_addr = el1->first_out_arc;
  }else
  {
    arc_element = sc_storage_get_element(it->results[1], TRUE);
  ...
  {
    arc_element = sc_storage_get_element(arc_addr, TRUE);
...
gboolean _sc_iterator3_f_a_f_next(sc_iterator3 *it)
{
  sc_addr arc_addr;
  sc_element *el1, *el2;
  sc_element *arc_element;
...
gboolean _sc_iterator3_a_a_f_next(sc_iterator3 *it)
{
  sc_addr arc_addr;
  sc_element *el1, *el2;
  sc_element *arc_element;
  ...
  if (SC_ADDR_IS_EMPTY(it->results[1]))
  {
    el1 = sc_storage_get_element(it->params[2].addr, TRUE);
