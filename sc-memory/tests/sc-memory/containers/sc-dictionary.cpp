...
TEST_F(ScDictionaryTest, smoke)
{
  ...
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str1, strlen(str1)));
  ...
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str2, strlen(str2)));
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str1, strlen(str1)));
  ...
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str3, strlen(str3)));
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str2, strlen(str2)));
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str1, strlen(str1)));
  ...
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str4, strlen(str4)));
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str3, strlen(str3)));
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str2, strlen(str2)));
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str1, strlen(str1)));
  ...
  auto const checkAfterRemove
    ...
    auto const checkExistence = [dictionary](sc_char const * string, sc_addr addr) {
      EXPECT_TRUE(sc_dictionary_is_in(dictionary, string, strlen(string)));
      sc_list * list = sc_dictionary_get(dictionary, string, strlen(string));
    ...
    auto const checkNonExistence = [dictionary](sc_char const * string, sc_addr addr) {
      EXPECT_FALSE(sc_dictionary_is_in(dictionary, string, strlen(string)));
      sc_list * list = sc_dictionary_get(dictionary, string, strlen(string));
      sc_iterator * it = sc_list_iterator(list);
      EXPECT_FALSE(sc_iterator_next(it));
...
TEST_F(ScDictionaryTest, CorrespondenceCheck)
{
  ...
  sc_dictionary_append(dictionary, str1, strlen(str1), &addr1);
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str1, strlen(str1)));
  EXPECT_FALSE(sc_dictionary_is_in(dictionary, "users_1_1", strlen("users_1_1")));
  EXPECT_FALSE(sc_dictionary_is_in(dictionary, "users_1_2", strlen("users_1_2")));
  EXPECT_FALSE(sc_dictionary_is_in(dictionary, "users_2", strlen("users_2")));
  EXPECT_FALSE(sc_dictionary_is_in(dictionary, "users_2_1", strlen("users_2_1")));
  EXPECT_FALSE(sc_dictionary_is_in(dictionary, "users_2_2", strlen("users_2_2")));
  ...
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str5, strlen(str5)));
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str4, strlen(str4)));
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str3, strlen(str3)));
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str2, strlen(str2)));
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str1, strlen(str1)));
  ...
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str6, strlen(str6)));
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str5, strlen(str5)));
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str4, strlen(str4)));
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str3, strlen(str3)));
  EXPECT_TRUE(sc_dictionary_is_in(dictionary, str2, strlen(str2)));
  ...
  sc_list * list = sc_dictionary_get(dictionary, str1, strlen(str1));
  sc_iterator * it = sc_list_iterator(list);
  ...
  list = sc_dictionary_get(dictionary, str2, strlen(str2));
  ...
  list = sc_dictionary_get(dictionary, str3, strlen(str3));
  it = sc_list_iterator(list);
  while (sc_iterator_next(it))
  {
    sc_addr const linkAddr = *(sc_addr *)sc_iterator_get(it);
  ...
  list = sc_dictionary_get(dictionary, str4, strlen(str4));
  it = sc_list_iterator(list);
  while (sc_iterator_next(it))
  {
    sc_addr const linkAddr = *(sc_addr *)sc_iterator_get(it);
  ...
  list = sc_dictionary_get(dictionary, str5, strlen(str5));
  it = sc_list_iterator(list);
  while (sc_iterator_next(it))
  {
    sc_addr const linkAddr = *(sc_addr *)sc_iterator_get(it);
  ...
  list = sc_dictionary_get(dictionary, str6, strlen(str6));
  it = sc_list_iterator(list);
  while (sc_iterator_next(it))
  {
    sc_addr const linkAddr = *(sc_addr *)sc_iterator_get(it);
