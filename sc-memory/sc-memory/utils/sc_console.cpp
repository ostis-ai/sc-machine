...
ScConsole::KeyCode GetKey(void)
{
  ...
  case 0:
  {
    ...
    switch (kk = getch())
    {
    case 71: return ScConsole::KeyCode::NumPad7;
    case 72: return ScConsole::KeyCode::NumPad8;
    case 73: return ScConsole::KeyCode::NumPad9;
    case 75: return ScConsole::KeyCode::NumPad4;
    case 77: return ScConsole::KeyCode::NumPad6;
    case 79: return ScConsole::KeyCode::NumPad1;
    case 80: return ScConsole::KeyCode::NumPad2;
    case 81: return ScConsole::KeyCode::NumPad3;
    case 82: return ScConsole::KeyCode::NumPad0;
    case 83: return ScConsole::KeyCode::NumDel;
    default: return static_cast<ScConsole::KeyCode>(kk - 59 + static_cast<uint8_t>(ScConsole::KeyCode::F1)); // Function keys
    }
  }
  case 224:
  {
    ...
    switch (kk = getch())
    {
    case 71: return ScConsole::KeyCode::Home;
    case 72: return ScConsole::KeyCode::Up;
    case 73: return ScConsole::KeyCode::PageUp;
    case 75: return ScConsole::KeyCode::Left;
    case 77: return ScConsole::KeyCode::Right;
    case 79: return ScConsole::KeyCode::End;
    case 80: return ScConsole::KeyCode::Down;
    case 81: return ScConsole::KeyCode::PageDown;
    case 82: return ScConsole::KeyCode::Insert;
    case 83: return ScConsole::KeyCode::Delete;
    default: return static_cast<ScConsole::KeyCode>(kk - 123 + static_cast<uint8_t>(ScConsole::KeyCode::F1)); // Function keys
    }
  }
  case 13: return ScConsole::KeyCode::Enter;
#if SC_IS_PLATFORM_WIN32
  case 27: return ScConsole::KeyCode::Escape;
#else // _WIN32
  ...
  case 27:
  {
    ...
    if (cnt >= 3 && getch() == '[')
    {
      switch (k = getch())
      {
      case 'A': return ScConsole::KeyCode::Up;
      case 'B': return ScConsole::KeyCode::Down;
      case 'C': return ScConsole::KeyCode::Right;
      case 'D': return ScConsole::KeyCode::Left;
      }
    }
    else
    {
...
#endif // _WIN32
  default: return static_cast<ScConsole::KeyCode>(k);
  }
}
...
std::string const & GetANSIColor(ScConsole::Color const c)
{
  ...
  case ScConsole::Color::Cyan: return ANSI_CYAN; // non-ANSI
  case ScConsole::Color::Red: return ANSI_RED; // non-ANSI
  case ScConsole::Color::Magneta: return ANSI_MAGENTA;
  case ScConsole::Color::Brown: return ANSI_BROWN;
  case ScConsole::Color::Grey: return ANSI_GREY;
  case ScConsole::Color::DarkGrey: return ANSI_DARKGREY;
  case ScConsole::Color::LightBlue: return ANSI_LIGHTBLUE; // non-ANSI
  case ScConsole::Color::LightGreen: return ANSI_LIGHTGREEN;
  case ScConsole::Color::LightCyan: return ANSI_LIGHTCYAN; // non-ANSI;
  case ScConsole::Color::LightRed: return ANSI_LIGHTRED; // non-ANSI;
...
std::string const & GetANSIBackgroundColor(ScConsole::Color const c)
{
  ...
  case ScConsole::Color::Cyan: return ANSI_BACKGROUND_CYAN;
  case ScConsole::Color::Red: return ANSI_BACKGROUND_RED;
...
void ScConsole::SetColor(Color c)
{
  ...
  SetConsoleTextAttribute(hConsole, (csbi.wAttributes & 0xFFF0) | ColorToWin(c)); // Foreground colors take up the least significant byte
#else
