...
sc_addr sc_event_add_incoming_arc_addr;
sc_addr sc_event_add_outgoing_arc_addr;
...
sc_result sc_keynodes_initialize(sc_memory_context * ctx, sc_addr const init_memory_generated_structure)
{
  ...
  SC_RESOLVE_KEYNODE(ctx, sc_event_add_incoming_arc_addr, sc_type_node_const_class, init_memory_generated_structure);
  SC_RESOLVE_KEYNODE(ctx, sc_event_add_outgoing_arc_addr, sc_type_node_const_class, init_memory_generated_structure);
