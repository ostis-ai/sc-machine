 ...
 */
_SC_EXTERN sc_result sc_memory_init_ext(sc_char const * ext_path, const sc_char ** enabled_list, sc_bool const init_memory_generated_upload, sc_char const * init_memory_generated_structure);
