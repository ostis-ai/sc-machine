...
#ifndef _sc_platform_h_
#define _sc_platform_h_
...
#define SC_IS_PLATFORM_WIN32 (SC_PLATFORM == SC_PLATFORM_WIN32)
#define SC_IS_PLATFORM_LINUX (SC_PLATFORM == SC_PLATFORM_LINUX)
#define SC_IS_PLATFORM_MAC (SC_PLATFORM == SC_PLATFORM_MAC)
#define SC_IS_PLATFORM_IOS (SC_PLATFORM == SC_PLATFORM_IOS)
#define SC_IS_PLATFORM_ANDROID (SC_PLATFORM == SC_PLATFORM_ANDROID)

#endif  // _sc_platform_h_