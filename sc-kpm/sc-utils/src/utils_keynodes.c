...
sc_addr keynode_action_erase_elements;
sc_addr keynode_init_memory_generated_structure;

sc_char const keynode_action_erase_elements_str[] = "action_erase_elements";

sc_result utils_keynodes_initialize(sc_addr const init_memory_generated_structure)
{
  RESOLVE_KEYNODE(s_erase_elements_ctx, keynode_action_erase_elements, init_memory_generated_structure);
