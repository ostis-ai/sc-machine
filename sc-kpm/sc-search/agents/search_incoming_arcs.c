...
sc_result agent_search_all_const_pos_incoming_arc(sc_event_subscription const * event, sc_addr arg)
{
  ...
  // check action type
  if (sc_helper_check_arc(s_default_ctx, keynode_action_all_input_const_pos_arc, action, sc_type_const_perm_pos_arc)
      == SC_FALSE)
  ...
  if (sc_iterator3_next(it1) == SC_TRUE)
  {
    ...
    it2 = sc_iterator3_a_a_f_new(s_default_ctx, 0, sc_type_const_perm_pos_arc, sc_iterator3_value(it1, 2));
...
sc_result agent_search_all_const_pos_incoming_arc_with_rel(sc_event_subscription const * event, sc_addr arg)
{
  ...
  if (sc_helper_check_arc(
          s_default_ctx, keynode_action_all_input_const_pos_arc_with_rel, action, sc_type_const_perm_pos_arc)
      == SC_FALSE)
    return SC_RESULT_ERROR_INVALID_TYPE;
  ...
  if (sc_iterator3_next(it1) == SC_TRUE)
  {
    ...
    while (sc_iterator3_next(it2) == SC_TRUE)
    {
      ...
      // iterate relations
      it3 = sc_iterator3_a_a_f_new(s_default_ctx, 0, sc_type_const_perm_pos_arc, sc_iterator3_value(it2, 1));
