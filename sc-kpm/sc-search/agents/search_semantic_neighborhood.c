...
void search_translation(sc_addr elem, sc_addr result, sc_bool sys_off)
{
    ...
    while (sc_iterator3_next(it3) == SC_TRUE)
    {
      ...
      while (sc_iterator3_next(it4) == SC_TRUE)
      {
        ...
        if (sc_helper_check_arc(
            ...
            == SC_TRUE)
        {
          appendIntoResult(result, sc_iterator3_value(it4, 0));
          appendIntoResult(result, sc_iterator3_value(it4, 1));
        }
      }
      ...
      appendIntoResult(result, sc_iterator3_value(it3, 2));
    }
  ...
  if (found == SC_TRUE)
  {
    appendIntoResult(result, keynode_nrel_translation);
  }
}
...
void search_arc_components(sc_addr elem, sc_addr result, sc_bool sys_off)
{
  ...
  appendIntoResult(result, begin);
  appendIntoResult(result, end);
}
...
void search_nonbinary_relation(sc_addr elem, sc_addr result, sc_bool sys_off)
{
  ...
  while (sc_iterator3_next(it1) == SC_TRUE)
  {
            ...
            s_default_ctx, keynode_nonbinary_relation, sc_iterator3_value(it1, 0), sc_type_const_perm_pos_arc))
    {
      ...
      appendIntoResult(result, sc_iterator3_value(it1, 0));
      appendIntoResult(result, sc_iterator3_value(it1, 1));
    }
  }
...
void search_typical_sc_neighborhood(sc_addr elem, sc_addr result, sc_bool sys_off)
{
  ...
  while (sc_iterator3_next(it0) == SC_TRUE)
  {
    if (SC_ADDR_IS_EQUAL(sc_iterator3_value(it0, 0), keynode_typical_sc_neighborhood))
    {
      ...
      appendIntoResult(result, sc_iterator3_value(it0, 1));
      appendIntoResult(result, sc_iterator3_value(it0, 0));
      continue;
    }
  ...
  if (found == SC_TRUE)
  {
    appendIntoResult(result, keynode_typical_sc_neighborhood);
  }
}
...
sc_result agent_search_full_semantic_neighborhood(sc_event_subscription const * event, sc_addr arg)
{
  ...
  if (sc_iterator3_next(it1) == SC_TRUE)
  {
    ...
    appendIntoResult(result, element);
    ...
    {
      appendIntoResult(result, keynode_system_element);
      appendIntoResult(result, sc_iterator3_value(sysElementIt3, 1));
      ...
      while (sc_iterator3_next(it3) == SC_TRUE)
      {
            ...
            == SC_TRUE)
        {
          ...
          while (sc_iterator3_next(it4) == SC_TRUE)
          {
            ...
            appendIntoResult(result, sc_iterator3_value(it4, 1));
            appendIntoResult(result, sc_iterator3_value(it4, 2));
      ...
      while (sc_iterator3_next(it3) == SC_TRUE)
      {
        ...
        if (SC_ADDR_IS_EQUAL(sc_iterator3_value(it3, 0), keynode_rrel_key_sc_element))
        {
          ...
          while (sc_iterator5_next(it_order2) == SC_TRUE)
          {
            ...
            appendIntoResult(result, sc_iterator5_value(it_order2, 1));
            appendIntoResult(result, sc_iterator5_value(it_order2, 3));
            if (SC_FALSE == key_order_found)
            {
              key_order_found = SC_TRUE;
              appendIntoResult(result, keynode_nrel_key_sc_element_base_order);
            }
          }
...
sc_result agent_search_links_of_relation_connected_with_element(sc_event_subscription const * event, sc_addr arg)
{
  ...
  appendIntoResult(result, param_elem);
  ...
  if (found == SC_TRUE)
  {
    appendIntoResult(result, param_rel);
  }
