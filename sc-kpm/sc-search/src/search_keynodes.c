...
sc_addr keynode_rrel_main_key_sc_element;
...
sc_char const keynode_rrel_main_key_sc_element_str[] = "rrel_main_key_sc_element";
...
sc_result search_keynodes_initialize(sc_memory_context * ctx, sc_addr const init_memory_generated_structure)
{
  ...
  RESOLVE_KEYNODE(ctx, keynode_rrel_main_key_sc_element, init_memory_generated_structure);
