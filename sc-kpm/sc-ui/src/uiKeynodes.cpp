...
sc_char const keynode_nrel_user_result_formats_str[] = "ui_nrel_user_result_formats";
...
sc_char const keynode_action_nrel_result_str[] = "nrel_result";
...
sc_char const keynode_displayed_result_str[] = "ui_displayed_result";
...
sc_addr keynode_nrel_user_result_formats;
...
sc_addr keynode_action_nrel_result;
...
sc_addr keynode_displayed_result;
...
sc_bool initialize_keynodes(sc_addr const init_memory_generated_structure)
{
  ...
  RESOLVE_KEYNODE(s_default_ctx, keynode_action_nrel_result, init_memory_generated_structure);
  ...
  RESOLVE_KEYNODE(s_default_ctx, keynode_nrel_user_result_formats, init_memory_generated_structure);
  ...
  RESOLVE_KEYNODE(s_default_ctx, keynode_displayed_result, init_memory_generated_structure);
