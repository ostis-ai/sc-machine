...
char const keynode_nrel_user_result_formats_str[] = "ui_nrel_user_result_formats";
...
char const keynode_action_nrel_result_str[] = "nrel_result";
...
char const keynode_displayed_result_str[] = "ui_displayed_result";
