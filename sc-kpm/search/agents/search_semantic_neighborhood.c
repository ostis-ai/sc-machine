...
void search_translation(sc_addr elem, sc_addr answer)
{
    sc_iterator5 *it5;
    ...
    while (sc_iterator5_next(it5) == SC_TRUE)
    {
        ...
        while (sc_iterator3_next(it3) == SC_TRUE)
        {
            ...
            {
                if (IS_SYSTEM_ELEMENT(sc_iterator3_value(it4, 1)) || IS_SYSTEM_ELEMENT(sc_iterator3_value(it4, 0)))
                    continue;
...
sc_result agent_search_full_semantic_neighborhood(sc_event *event, sc_addr arg)
{
    ...
    if (sc_iterator3_next(it1) == SC_TRUE)
    {
        ...
        while (sc_iterator3_next(it2) == SC_TRUE)
        {
            ...
            // search translation for element
            search_translation(sc_iterator3_value(it2, 2), answer);
