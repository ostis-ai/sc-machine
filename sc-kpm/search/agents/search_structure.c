...
void search_subclasses_rec(sc_addr elem, sc_addr answer)
{
    sc_iterator3 *it2;
    sc_iterator5 *it5, *it_order;
    ...
    while (sc_iterator5_next(it5) == SC_TRUE)
    {
        ...
        while (sc_iterator3_next(it2) == SC_TRUE)
        {
            ...
            search_subclasses_rec(sc_iterator3_value(it2, 2), answer);
        }
        sc_iterator3_free(it2);
    }
    sc_iterator5_free(it5);
...
sc_result agent_search_all_subclasses_in_quasybinary_relation(sc_event *event, sc_addr arg)
{
    ...
    if (sc_iterator3_next(it1) == SC_TRUE)
    {
        ...
        search_subclasses_rec(sc_iterator3_value(it1, 2), answer);
    }
    sc_iterator3_free(it1);
...
void search_superclasses_rec(sc_addr elem, sc_addr answer)
{
    sc_iterator3 *it3;
    sc_iterator5 *it5;
    ...
    while (sc_iterator3_next(it3) == SC_TRUE)
    {
        ...
        while (sc_iterator5_next(it5) == SC_TRUE)
        {
            ...
            if (sc_helper_check_arc(keynode_quasybinary_relation, sc_iterator5_value(it5, 4), sc_type_arc_pos_const_perm) == SC_TRUE)
            {
                ...
                search_superclasses_rec(sc_iterator5_value(it5, 2), answer);
            }
        }
        sc_iterator5_free(it5);
...
sc_result agent_search_all_superclasses_in_quasybinary_relation(sc_event *event, sc_addr arg)
{
    ...
    if (sc_iterator3_next(it1) == SC_TRUE)
    {
        ...
        search_superclasses_rec(sc_iterator3_value(it1, 2), answer);
    }
    sc_iterator3_free(it1);
