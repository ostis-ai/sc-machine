...
sc_result operation_search_all_const_pos_input_arc(sc_event *event, sc_addr arg)
{
    ...
    // check question type
    if (sc_helper_check_arc(search_keynode_question_all_input_const_pos_arc, question, sc_type_arc_pos_const_perm) == SC_FALSE)
...
sc_result operation_search_all_const_pos_input_arc_with_rel(sc_event *event, sc_addr arg)
{
    ...
    // check question type
    if (sc_helper_check_arc(search_keynode_question_all_input_const_pos_arc_with_rel, question, sc_type_arc_pos_const_perm) == SC_FALSE)
        return SC_RESULT_ERROR_INVALID_TYPE;
