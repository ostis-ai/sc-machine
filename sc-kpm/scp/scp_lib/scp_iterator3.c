...
scp_iterator3 *scp_iterator3_new(sc_memory_context *context, scp_operand *param1, scp_operand *param2, scp_operand *param3)
{
    ...
    {
        case 0x001:
            return (scp_iterator3 *)sc_iterator3_f_a_a_new(context, param1->addr, param2->element_type, param3->element_type);
        case 0x100:
            return (scp_iterator3 *)sc_iterator3_a_a_f_new(context, param1->element_type, param2->element_type, param3->addr);
        case 0x101:
