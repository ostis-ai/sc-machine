...
#include "SCPOperatorEraseSetStr5.hpp"
...
std::string SCPOperatorEraseSetStr5::GetTypeName()
{
    return "eraseSetStr5";
}

sc_result SCPOperatorEraseSetStr5::Parse()
{
    return SCPOperatorElStr5::Parse();
}

sc_result SCPOperatorEraseSetStr5::Execute()
{
