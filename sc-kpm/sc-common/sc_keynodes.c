    ...
    sc_addr const init_memory_generated_structure)
{
  if (sc_helper_resolve_system_identifier(ctx, sys_idtf, keynode) == SC_FALSE)
  {
    *keynode = sc_memory_node_new(ctx, sc_type_node | sc_type_const);
    ...
    if (sc_helper_set_system_identifier_ext(ctx, *keynode, sys_idtf, (sc_uint32)strlen(sys_idtf), &fiver) !=
        SC_RESULT_OK)
      return SC_RESULT_ERROR;
    _sc_common_add_to_init_generated_memory_structure(ctx, fiver.addr1, init_memory_generated_structure);
    _sc_common_add_to_init_generated_memory_structure(ctx, fiver.addr2, init_memory_generated_structure);
    _sc_common_add_to_init_generated_memory_structure(ctx, fiver.addr3, init_memory_generated_structure);
    _sc_common_add_to_init_generated_memory_structure(ctx, fiver.addr4, init_memory_generated_structure);
    _sc_common_add_to_init_generated_memory_structure(ctx, fiver.addr5, init_memory_generated_structure);
