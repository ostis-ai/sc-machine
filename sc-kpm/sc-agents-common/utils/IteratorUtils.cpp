...
vector<ScAddr> IteratorUtils::getAllWithType(ScMemoryContext * ms_context, ScAddr const & set, ScType scType)
{
...
bool IteratorUtils::addNodeWithOutRelationToOutline(ScMemoryContext * ms_context, ScAddr const & node,
