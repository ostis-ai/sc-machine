...
std::pair<ScTemplate *, ScTemplateParams> ScMemoryMakeTemplateJsonAction::GetTemplate(
...
ScTemplate * ScMemoryMakeTemplateJsonAction::MakeTemplate(ScMemoryJsonPayload const & triples)
{
