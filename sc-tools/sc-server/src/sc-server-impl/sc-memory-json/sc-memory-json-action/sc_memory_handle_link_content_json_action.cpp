...
sc_bool ScMemoryHandleLinkContentJsonAction::SetContent(ScMemoryContext * context, ScMemoryJsonPayload const & atom)
{
...
ScMemoryJsonPayload ScMemoryHandleLinkContentJsonAction::GetContent(
    ScMemoryContext * context,
...
std::vector<size_t> ScMemoryHandleLinkContentJsonAction::FindLinksByContent(
    ScMemoryContext * context,
    ScMemoryJsonPayload const & atom)
{
  auto const & data = atom["data"];
...
std::vector<size_t> ScMemoryHandleLinkContentJsonAction::FindLinksByContentSubstring(
    ScMemoryContext * context,
    ScMemoryJsonPayload const & atom)
{
  auto const & data = atom["data"];
...
std::vector<std::string> ScMemoryHandleLinkContentJsonAction::FindLinksContentsByContentSubstring(
    ScMemoryContext * context,
    ScMemoryJsonPayload const & atom)
{
  auto const & data = atom["data"];
