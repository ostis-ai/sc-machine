...
#include "sc_server_template_test.hpp"
...
public:
  void Setup(size_t constrCount) override
  {
    ...
    m_templ.TripleWithRelation(
        ScType::NodeVarClass, ScType::EdgeDCommonVar, "_tuple", ScType::EdgeAccessVarPosPerm, ScType::NodeVarNoRole);
    m_templ.Triple(ScType::NodeVarClass, ScType::EdgeAccessVarPosPerm, node);
