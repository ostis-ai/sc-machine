...
void PrintStartMessage(std::string const & binaryName)
{
  std::cout << "Usage:\n"
            ...
            << "  --binaries|-b <directory>                       Provide a path to directory with knowledge base "
               "binaries. Knowledge base binaries should be generated by sc-builder.\n"
            << "  --extensions|-e <directory>                        Provide a path to directories containing "
               "extensions. Extensions should represent compiled dynamic libraries with sc-module of agents.\n\n"
            << "Options:\n"
            << "  --config|-c <project>.ini                          Provide a path to configuration file. "
               "Configuration file can be used to set additional (optional) options for "
            << binaryName << ".\n"
            << "  --clear                                            Run sc-memory in the mode when it overwrites "
               "existing knowledge base binaries.\n"
            << "  --verbose|-v                                       Shutdown without dumping sc-memory into knowledge "
               "binaries.\n"
            << "  --test|-t                                          Test sc-memory state " << binaryName
